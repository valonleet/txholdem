...
bool inPlay(deck::size_type, deck&);	// return true if a card is in play (i.e. it is true)
deck::size_type randomCard(deck&);		// generate a random card that is not in play
